...
fn basic_wallet_and_p2id() {
    ...
    expect!["21440"].assert_eq(stripped_mast_size_str(&tx_script_package));
    ...
    expect!["21547"].assert_eq(stripped_mast_size_str(&note_package));
    ...
    expect!["25037"].assert_eq(stripped_mast_size_str(&p2ide_package));
}
